        ...
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2   bg-white/80 backdrop-blur-md shadow">
                <div className=" h-screen flex flex-col items-center justify-center m-10">
                    ...
                    <img src="/magnifying-glass.png" className='w-40' alt="Magnifying Glass Image" />
                ...
                <div className=" h-screen overflow-hidden">
                    ...
                    <img src="/engineer.png" className='h-1/3 absolute right-0 bottom-0 md:w-1/3 md:h-auto' alt="Engineer Image" />
